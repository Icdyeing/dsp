# JES_Chorus_101219148_zhousheng.py
...
def song():
    ...
    playNote(82, minDuration*3, 63)
    playNote(79, minDuration*2, 0)#pause
    playNote(84, minDuration*2, 63)
    playNote(82, minDuration*2, 63)
    playNote(81, minDuration*2, 63)
    playNote(72, minDuration*2, 63)
    playNote(81, minDuration*1, 63)
    playNote(81, minDuration*5, 63)
    playNote(79, minDuration*2, 0)#pause
    
    playNote(82, minDuration*2, 63)
    playNote(81, minDuration*2, 63)
    playNote(77, minDuration*2, 63)
    playNote(83, minDuration*2, 63)##4+
    playNote(79, minDuration*1, 63)
    playNote(79, minDuration*13, 63)
